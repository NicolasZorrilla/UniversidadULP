...
public class AlumnoVista extends javax.swing.JInternalFrame {
    ...
    private void jbuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbuscarActionPerformed
        try {
            ...
            Alumno alumn = alumnData.buscarAlumnoPorDni(Integer.parseInt(jdocumento.getText()));
            japellido.setText(alumn.getApellido());
            jnombre.setText(alumn.getNombre());
            jDateChooser1.setDate(Date.valueOf(alumn.getFechaNacimiento()));
            jRadioButton1.setSelected(alumn.isEstado());
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(this, "El DNI ingresado es invalido.");
        }
